...
import co.za.enkstudio.domain.Employee;
import co.za.enkstudio.repository.EmployeeRepository;
...
class EmployeeResourceIT {
    ...
    void partialUpdateEmployeeWithPatch() throws Exception {
        ...
        partialUpdatedEmployee.firstName(UPDATED_FIRST_NAME).lastName(UPDATED_LAST_NAME).commissionPct(UPDATED_COMMISSION_PCT);
