...
describe('Task e2e test', () => {
  ...
  describe('new Task page', () => {
    ...
    it('should create an instance of Task', () => {
      cy.get(`[data-cy="title"]`).type('versus bunch');
      cy.get(`[data-cy="title"]`).should('have.value', 'versus bunch');

      cy.get(`[data-cy="description"]`).type('provided meanwhile');
      cy.get(`[data-cy="description"]`).should('have.value', 'provided meanwhile');
