...
describe('Location e2e test', () => {
  ...
  describe('new Location page', () => {
    ...
    it('should create an instance of Location', () => {
      cy.get(`[data-cy="streetAddress"]`).type('ouch including impure');
      cy.get(`[data-cy="streetAddress"]`).should('have.value', 'ouch including impure');

      cy.get(`[data-cy="postalCode"]`).type('almost melodic ah');
      cy.get(`[data-cy="postalCode"]`).should('have.value', 'almost melodic ah');

      cy.get(`[data-cy="city"]`).type('North Jaquelinchester');
      cy.get(`[data-cy="city"]`).should('have.value', 'North Jaquelinchester');

      cy.get(`[data-cy="stateProvince"]`).type('or anxiously');
      cy.get(`[data-cy="stateProvince"]`).should('have.value', 'or anxiously');
