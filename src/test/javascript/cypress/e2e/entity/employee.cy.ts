...
describe('Employee e2e test', () => {
  ...
  describe('new Employee page', () => {
    ...
    it('should create an instance of Employee', () => {
      cy.get(`[data-cy="firstName"]`).type('Percival');
      cy.get(`[data-cy="firstName"]`).should('have.value', 'Percival');

      cy.get(`[data-cy="lastName"]`).type('Mraz');
      cy.get(`[data-cy="lastName"]`).should('have.value', 'Mraz');

      cy.get(`[data-cy="email"]`).type('Birdie35@hotmail.com');
      cy.get(`[data-cy="email"]`).should('have.value', 'Birdie35@hotmail.com');

      cy.get(`[data-cy="phoneNumber"]`).type('snooze advanced which');
      cy.get(`[data-cy="phoneNumber"]`).should('have.value', 'snooze advanced which');

      cy.get(`[data-cy="hireDate"]`).type('2024-03-07T19:02');
      cy.get(`[data-cy="hireDate"]`).blur();
      cy.get(`[data-cy="hireDate"]`).should('have.value', '2024-03-07T19:02');

      cy.get(`[data-cy="salary"]`).type('23838');
      cy.get(`[data-cy="salary"]`).should('have.value', '23838');

      cy.get(`[data-cy="commissionPct"]`).type('12536');
      cy.get(`[data-cy="commissionPct"]`).should('have.value', '12536');
