...
describe('Job e2e test', () => {
  ...
  describe('new Job page', () => {
    ...
    it('should create an instance of Job', () => {
      cy.get(`[data-cy="jobTitle"]`).type('Investor Program Architect');
      cy.get(`[data-cy="jobTitle"]`).should('have.value', 'Investor Program Architect');

      cy.get(`[data-cy="minSalary"]`).type('13399');
      cy.get(`[data-cy="minSalary"]`).should('have.value', '13399');

      cy.get(`[data-cy="maxSalary"]`).type('24074');
      cy.get(`[data-cy="maxSalary"]`).should('have.value', '24074');
