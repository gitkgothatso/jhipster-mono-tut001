...
describe('Department e2e test', () => {
  ...
  const departmentSample = { departmentName: 'as aha fairly' };
  ...
  describe('new Department page', () => {
    ...
    it('should create an instance of Department', () => {
      cy.get(`[data-cy="departmentName"]`).type('snag outside');
      cy.get(`[data-cy="departmentName"]`).should('have.value', 'snag outside');
