...
describe('Job Management Update Component', () => {
  ...
  describe('ngOnInit', () => {
    it('Should call Task query and add missing value', () => {
      ...
      const tasks: ITask[] = [{ id: 19736 }];
      job.tasks = tasks;

      const taskCollection: ITask[] = [{ id: 23890 }];
    ...
    it('Should call Employee query and add missing value', () => {
      const job: IJob = { id: 456 };
      const employee: IEmployee = { id: 19887 };
      job.employee = employee;

      const employeeCollection: IEmployee[] = [{ id: 13620 }];
    ...
    it('Should update editForm', () => {
      const job: IJob = { id: 456 };
      const task: ITask = { id: 27581 };
      job.tasks = [task];
      const employee: IEmployee = { id: 13479 };
      job.employee = employee;
