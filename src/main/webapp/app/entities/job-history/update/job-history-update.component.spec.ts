...
describe('JobHistory Management Update Component', () => {
  ...
  describe('ngOnInit', () => {
    it('Should call job query and add missing value', () => {
      ...
      const job: IJob = { id: 8001 };
      jobHistory.job = job;

      const jobCollection: IJob[] = [{ id: 20122 }];
    ...
    it('Should call department query and add missing value', () => {
      const jobHistory: IJobHistory = { id: 456 };
      const department: IDepartment = { id: 6780 };
      jobHistory.department = department;

      const departmentCollection: IDepartment[] = [{ id: 31213 }];
    ...
    it('Should call employee query and add missing value', () => {
      const jobHistory: IJobHistory = { id: 456 };
      const employee: IEmployee = { id: 18055 };
      jobHistory.employee = employee;

      const employeeCollection: IEmployee[] = [{ id: 28072 }];
    ...
    it('Should update editForm', () => {
      const jobHistory: IJobHistory = { id: 456 };
      const job: IJob = { id: 20137 };
      jobHistory.job = job;
      const department: IDepartment = { id: 2979 };
      jobHistory.department = department;
      const employee: IEmployee = { id: 23442 };
      jobHistory.employee = employee;
